...
public static class ComputerUtil
{
    ...
    public static List<DiskInfo> GetDiskInfos()
    {
        ...
        {
            var output =
                ShellHelper.Bash(@"df -mT | awk '/^\/dev\/(sd|vd|xvd|nvme|sda|vda)/ {print $1,$2,$3,$4,$5,$6}'");
            var disks = output.Split('\n', StringSplitOptions.RemoveEmptyEntries);
            if (disks.Length < 1) return diskInfos;
    ...
    //     var resp = JsonConvert.DeserializeObject<IpCnResp>(str);
    ...
    public static string GetRunTime()
    {
        ...
        {   
            ...
            string output = ShellUtil
                ...
                .Trim();
            runTime = DateTimeUtil.FormatTime(
        ...
        else
        {
            ...
            if (outputArr.Length == 2)
                runTime = DateTimeUtil.FormatTime((DateTime.Now - outputArr[1].Split('.')[0].ParseToDateTime())
