import{aB as p,aC as e,aD as V,aE as C,aF as O,aG as G,aH as H,d as E,aj as K,ak as L,x as D,am as B,aI as q,aJ as J,ap as N,B as n,aK as W,aq as Q,aL as U}from"./index-BZUOWCTQ.js";function M(r,b="default",a=[]){const{children:i}=r;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const F="DESCRIPTION_ITEM_FLAG";function X(r){return typeof r=="object"&&r&&!Array.isArray(r)?r.type&&r.type[F]:!1}const Y=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
